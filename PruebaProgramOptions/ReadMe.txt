========================================================================
    APLICACIÓN DE CONSOLA: PruebaProgramOptions 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación PruebaProgramOptions.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación PruebaProgramOptions.


PruebaProgramOptions.vcxproj
...
PruebaProgramOptions.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado PruebaProgramOptions.pch y un archivo de tipos 
